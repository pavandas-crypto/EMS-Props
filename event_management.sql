...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2026 at 02:40 AM
...
(1, 'Tech Conference 2026', 'Annual technology event', '2026-06-01 10:00:00', '2026-06-01 17:00:00', 'Mumbai Expo Center', 'all', 1, NULL, NULL, 1, NULL);
...
(1, 1, 1, 'TCS', 'Engineer', 'TSSIA123', 1, 3, '2026-04-25 00:31:25', NULL, NULL, NULL, 1, NULL),
...
(1, 1, 'Registration Successful 🎉', 'You have successfully registered for the event.', 1, 'Your registration is under review. Please wait for approval confirmation via email.', NULL, NULL, 1, NULL);
...
(1, 'Tester One', 'admin@mail.com', '123456', 'admin', '2026-04-25 00:31:25', NULL),
...
--
ALTER TABLE `participants`
  MODIFY `participant_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `registration_success_settings`
  MODIFY `success_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
